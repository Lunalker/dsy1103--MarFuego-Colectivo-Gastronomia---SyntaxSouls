...
public class BoletaCaja {
    ...
    @Past(message = "La fecha introducida debe ser valida")
    ...
    public BoletaCaja(Long id, String nombreCliente, Double montoTotal, LocalDate fecha, MetodoPago metodoPago) {
        this.id = id;
